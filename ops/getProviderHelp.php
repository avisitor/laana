...
<ul>
  <li><span class="searchtype">Match any of the words anywhere</span>: matches sentences with any of the words in your search expression, e.g. <span class="searchterm">hale kuai</span> returns sentences containing <span class="searchterm">hale</span>, <span class="searchterm">kuai</span> or both</li>
  <li><span class="searchtype">Match all words anywhere in sentences</span>: matches sentences that includes all the words in your search expression in any order, e.g. <span class="searchterm">hale kuai</span> returns sentences like <span class="searchterm">Ua koha oia i ka hale no ke kuai ana</span> as well as <span class="searchterm">Ua kuai oia i ka hale</span></li>
  <li><span class="searchtype">Match exact phrase in sentences</span>: matches your search expression exactly as entered, e.g. <span class="searchterm">hale kuai</span> returns sentences containing <span class="searchterm">hale kuai</span> in that exact order</li>
...
<ul>
  ...
  <li><span class="searchtype">Match all of the words in any order</span>: matches sentences that includes all the words in your search expression in any order, e.g. <span class="searchterm">hale kuai</span> returns sentences like <span class="searchterm">Ua koha oia i ka hale no ke kuai ana</span> as well as <span class="searchterm">Ua kuai oia i ka hale</span></li>
  <li><span class="searchtype">Exact match of one or more words</span>: matches your search expression exactly as entered. Whether or not Hawaiian characters are treated the same as characters without diacritical marks depends on the No Diacriticals setting below. If No Diacriticals is not set, <span class="searchterm">hale kuai</span> returns sentences containing <span class="searchterm">hale kuai</span> but not <span class="searchterm">hale kū'ai</span> while if it is set, both are returned</li>
  <li><span class="searchtype">Regular expression match</span>: matches your <a class="fancy" target="_blank" href="https://www.guru99.com/regular-expressions.html">regular expression</a>, e.g. <span class="searchterm">ho\w{5}\skaua</span> to find sentences containing a 7-letter word starting with ho and followed by a space and kaua</li>
</ul>
<p><span class="searchtype">No Diacriticals</span>: diacritical marks and 'okina are ignored. For example, searching for <span class="searchterm">ho'okipa</span> matches <span class="searchterm">hookipa</span> as well as <span class="searchterm">ho'okipa</span>; searching for <span class="searchterm">hookipa</span> returns the same results. Without No Diacriticals, searching for <span class="searchterm">ho'okipa</span> returns only results with <span class="searchterm">ho'okipa</span> while searching for <span class="searchterm">hookipa</span> matches only on <span class="searchterm">hookipa</span></p>
HTML;
}
